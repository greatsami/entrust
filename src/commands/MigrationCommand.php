...
class MigrationCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->line('');
        $this->info( "Tables: $rolesTable, $roleUserTable, $permissionsTable, $permissionRoleTable, $userPermissionTable" );
    ...
    protected function createMigration($rolesTable, $roleUserTable, $permissionsTable, $permissionRoleTable, $userPermissionTable)
    {
        ...
        $data = compact('rolesTable', 'roleUserTable', 'permissionsTable', 'permissionRoleTable', 'userPermissionTable', 'usersTable', 'userKeyName');
